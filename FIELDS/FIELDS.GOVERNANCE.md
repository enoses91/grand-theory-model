...
- Observed enforcement patterns or failures **do not imply motive**; they arise endogenously from Π_G and U_G under COR.THETA, χ, CI_load, COR.KAPPA, and topology constraints.
...
Destabilizing control surfaces increase CI_load, COR.KAPPA_load, and COR.PHI_proc erosion as downstream effects.
...
- **COR.THETA_exec / COR.THETA_coord / COR.THETA_adapt:** execution throughput, cross-unit coordination, reform capacity
...
- **COR.KAPPA_load:** rule density, compliance steps, review churn
- **COR.KAPPA_threat:** coercive framing, punitive enforcement visibility
- **COR.KAPPA_velocity:** rapid rule churn, emergency signaling
...
- **COR.PHI_proc:** eroded by asymmetry, opacity, and delay
- **COR.PHI_exp:** eroded by service failure and backlog
- **COR.PHI_sac:** destabilized by overreach into sacral domains without procedural credibility
...
- COR.KAPPA_velocity spikes
- COR.PHI_proc collapse
...
- ignoring CI_load or COR.THETA_adapt
