...
- **`BOUNDS.ECO_GEO` (Eco-Geographic Feasibility):**  
  Hazard regimes, infrastructure damage, and environmental recovery demands act as exogenous workload injections, increasing execution backlog, authority overload, and latency independent of governance quality or intent.
...
Eco-geographic shocks are a canonical source of governance residuals (ε_G), including:

- latency overshoot from disaster recovery backlogs,
- enforcement leakage under emergency or degraded conditions,
- authority overload during prolonged environmental response.

These residuals inject bounded load into κ, h, and θ without introducing new agents or causal primitives.
...
- **Eco-Geo Recovery Overload:**  
  Persistent environmental damage and recovery demand saturate governance execution capacity, producing backlog and apparent failure without governance misdesign.
